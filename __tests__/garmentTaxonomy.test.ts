...
import { Categories, CategoriesByGender, CategoryDefinitions, Colours, Fabrics, Occasions, Genders } from '../constants/theme';
import {
  CATEGORIES, CATEGORIES_BY_GENDER, CATEGORY_DEFINITIONS, COLOURS, FABRICS, GENDERS, OCCASIONS, TAXONOMY_VERSION,
